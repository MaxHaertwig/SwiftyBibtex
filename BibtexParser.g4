...
bibFile : ( string | preamble | comment | publication )* ;
...
preamble : AT PREAMBLE OPEN_CURLY concatString CLOSE_CURLY
         | AT PREAMBLE OPEN_PAREN concatString CLOSE_PAREN ;
...
field : fieldName=NAME CURLY_VALUE_START curlyValue CURLY_VALUE_CLOSE_CURLY
      | fieldName=NAME EQUALS concatString ;

concatString : fieldString ( HASH fieldString )* ;
