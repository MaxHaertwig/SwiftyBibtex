...
open class BibtexLexer: Lexer {
	...
	static let CURLY_VALUE_START=1, AT=2, COMMA=3, EQUALS=4, HASH=5, OPEN_CURLY=6, 
            CLOSE_CURLY=7, OPEN_PAREN=8, CLOSE_PAREN=9, STRING=10, PREAMBLE=11, 
            COMMENT_START_CURLY=12, COMMENT_START_PAREN=13, NAME=14, STRING_LITERAL=15, 
            WS=16, CURLY_VALUE_OPEN_CURLY=17, CURLY_VALUE_CLOSE_CURLY=18, 
            CURLY_VALUE=19, PAREN_VALUE_OPEN_PAREN=20, PAREN_VALUE_CLOSE_PAREN=21, 
            PAREN_VALUE=22
	...
	static let ruleNames: [String] = [
		...
		"OPEN_PAREN", "CLOSE_PAREN", "STRING", "PREAMBLE", "COMMENT_START", "COMMENT_START_CURLY", 
